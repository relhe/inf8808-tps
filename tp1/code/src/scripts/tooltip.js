...
export function getContents(d) {
  ...
  */
  return `
    <div style="font-family: 'Grenze Gotish'; font-size: 24px; font-weight: normal; margin-bottom: 8px;">
      ${d.group}
    </div>
    <div>
      <strong>Player Name:</strong> ${d.player}
    </div>
    <div>
      <strong>Line Count:</strong> ${d.lines}
    </div>
  `;
}
